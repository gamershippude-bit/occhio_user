...
from main import app, get_occhio_instance
...
def perguntar():
    """
    Endpoint /perguntar - Responde pergunta sobre a imagem (chat com IA)
...
def estatistica():
    """
    Endpoint /estatistica - Retorna estatísticas técnicas detalhadas
    REQUER: apenas imagem
    """
    try:
        occhio = get_occhio_instance()
